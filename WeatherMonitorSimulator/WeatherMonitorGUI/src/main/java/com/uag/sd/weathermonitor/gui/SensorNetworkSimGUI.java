...
import com.uag.sd.weathermonitor.model.router.RouterData;
...
public class SensorNetworkSimGUI {
	...
	class EndpointLog implements DeviceLog<EndpointData>{
		...
		public void info(EndpointData msg) {
			...
			endpointInfoConsole.setCaretPosition(endpointInfoConsole.getDocument().getLength());
		}
		...
		public void debug(EndpointData msg) {
			...
			endpointDebugConsole.setCaretPosition(endpointDebugConsole.getDocument().getLength());
		}
	...
	class RouterLog implements DeviceLog<RouterData>{

		@Override
		public void info(RouterData msg) {
			StringBuilder builder = new StringBuilder();
			builder.append(dateFormatter.format(new Date(System.currentTimeMillis())) );
			builder.append(" - ID ");
			builder.append(msg.getRouterId());
			builder.append(", Value: ");
			builder.append(msg.getValue());
			builder.append(System.lineSeparator());
			routerInfoConsole.append(builder.toString());
			routerInfoConsole.setCaretPosition(routerInfoConsole.getDocument().getLength());
		}

		@Override
		public void debug(RouterData msg) {
			StringBuilder builder = new StringBuilder();
			builder.append(dateFormatter.format(new Date(System.currentTimeMillis())) );
			builder.append(" - ID ");
			builder.append(msg.getRouterId());
			...
			routerDebugConsole.setCaretPosition(routerDebugConsole.getDocument().getLength());
		}
																								...
																								removeEndpointButton.setEnabled(false);
																											...
																											gl_panel_3.createParallelGroup(Alignment.LEADING)
																												.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
																													...
																													.addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
																														.addComponent(tabbedPane_3, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
																														.addComponent(separator_1, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
																														.addComponent(tabbedPane_2, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
																														.addComponent(scrollPane_7, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
																										...
																										gl_panel_7.setHorizontalGroup(
																											gl_panel_7.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_7.createSequentialGroup()
																													.addContainerGap()
																													.addComponent(scrollPane_10, GroupLayout.DEFAULT_SIZE, 547, Short.MAX_VALUE)
																													.addContainerGap())
																										);
																										gl_panel_7.setVerticalGroup(
																											gl_panel_7.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_7.createSequentialGroup()
																													.addContainerGap()
																													.addComponent(scrollPane_10, GroupLayout.DEFAULT_SIZE, 275, Short.MAX_VALUE)
																													.addContainerGap())
																										);
																										...
																										gl_panel_8.setHorizontalGroup(
																											gl_panel_8.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_8.createSequentialGroup()
																													.addContainerGap()
																													.addComponent(scrollPane_11, GroupLayout.DEFAULT_SIZE, 547, Short.MAX_VALUE)
																													.addContainerGap())
																										);
																										gl_panel_8.setVerticalGroup(
																											gl_panel_8.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_8.createSequentialGroup()
																													.addContainerGap()
																													.addComponent(scrollPane_11, GroupLayout.DEFAULT_SIZE, 275, Short.MAX_VALUE)
																													.addContainerGap())
																										);
																											...
																											gl_panel_5.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_5.createSequentialGroup()
																													...
																													.addGroup(gl_panel_5.createParallelGroup(Alignment.LEADING)
																														.addComponent(scrollPane_8, GroupLayout.DEFAULT_SIZE, 547, Short.MAX_VALUE)
																										...
																										gl_panel_5.setVerticalGroup(
																											gl_panel_5.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_5.createSequentialGroup()
																													...
																													.addComponent(btnClear)
																													.addPreferredGap(ComponentPlacement.RELATED)
																													.addComponent(scrollPane_8, GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
																													.addContainerGap())
																										);
																										...
																										routerInfoConsole.setFont(new Font("Lucida Sans Typewriter", Font.PLAIN, 11));
																											...
																											gl_panel_6.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_6.createSequentialGroup()
																													...
																													.addGroup(gl_panel_6.createParallelGroup(Alignment.LEADING)
																														.addComponent(scrollPane_9, GroupLayout.DEFAULT_SIZE, 547, Short.MAX_VALUE)
																										...
																										gl_panel_6.setVerticalGroup(
																											gl_panel_6.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_6.createSequentialGroup()
																													...
																													.addComponent(btnClear_1)
																													.addPreferredGap(ComponentPlacement.RELATED)
																													.addComponent(scrollPane_9, GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
																													.addContainerGap())
																										);
																										...
																										routerDebugConsole.setFont(new Font("Lucida Sans Typewriter", Font.PLAIN, 11));
